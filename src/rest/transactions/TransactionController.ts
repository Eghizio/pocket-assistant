...
import { ReceiptPaginationQuerySchema, ReceiptProductsParamsSchema, ReceiptSchema } from "./validation";

const userId = "1"; // Todo: Get user ID from some session or token

const getAllReceipts = createValidatedHandler({ query: ReceiptPaginationQuerySchema })((req, res) => {
...
const getProductsByReceipt = createValidatedHandler({ params: ReceiptProductsParamsSchema })((req, res) => {
...
const addReceipt = createValidatedHandler({ body: ReceiptSchema })((req, res) => {
