...
const handlerSchema: ValidatedRequestHandler<
...
const validatedHandler = createValidatedHandler({ body: bodySchema })(
  (req, res, next) => {
...
const cyckiHandler = createValidatedHandler({ body: dupaSchema })(
  (req, res) => {
    const { dupa } = req.body;
